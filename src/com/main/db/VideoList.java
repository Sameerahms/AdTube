...
OtpDb otpDb = new OtpDb();
	...
	public String getVideo1() throws SQLException {
		...
		String query = "SELECT video1 FROM playlist WHERE mobile_number='" +OtpDb.phoneNum + "'";
	...
	public String getVideo2() throws SQLException {
		...
		String query = "SELECT video2 FROM playlist WHERE mobile_number='" + OtpDb.phoneNum + "'";
	...
	public String getVideo3() throws SQLException {
		...
		String AuthKey = "";
		PreparedStatement statement = null;
		String query = "SELECT video3 FROM playlist WHERE mobile_number='" + OtpDb.phoneNum + "'";
	...
	public String getVideo4() throws SQLException {
		...
		String query = "SELECT video4 FROM playlist WHERE mobile_number='" + OtpDb.phoneNum + "'";
		System.out.println(query);
	...
	public String getVideo5() throws SQLException {
		...
		String query = "SELECT video5 FROM playlist WHERE mobile_number='" + OtpDb.phoneNum + "'";
		System.out.println(query);
	...
	public void updatVideo1(String phone, String video) {
		...
		try {
			...
			System.out.println("UPDATE Video1");
	...
	public void updatVideo3(String phone, String video) {
		...
		try {
			...
			statement.executeUpdate();
			System.out.println("UPDATE Video3");
	...
	public void updatVideo4(String phone, String video) {
		...
		try {
			...
			statement.executeUpdate();
			System.out.println("UPDATE Video4");
	...
	public void updatVideo5(String phone, String video) {
		...
		try {
			...
			statement.executeUpdate();
			System.out.println("UPDATE Video5");
